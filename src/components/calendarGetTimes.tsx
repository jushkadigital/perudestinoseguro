...
export default function CustomEventCalendarByYear({data, year,currentMonth}:Props){
  ...
  <div className="h-full lg:w-10/12 w-full  mt-5">
        ...
        <thead className="bg bg-[#D20000]">
          ...
          <tr>
              <td className="border border-gray-700">
                  <p className="lg:text-3xl text-sm text-gray-700 font-bold">
                  {d}
                </p>
              </td>
              <td className="border border-gray-700">
              ...
              <td className="border border-gray-700">
                  <p className="lg:text-xl text-sm text-gray-700 font-semibold">
                  {time.split("-")[0]} Dias
                </p>
              </td>
              <td className="border border-gray-700">
                  <p className="lg:text-xl text-sm text-gray-900 font-bold capitalize">
                  {state}
                </p>
              </td>
            </tr>
